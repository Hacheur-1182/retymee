...
const API_KEY = 'cZbiWtpdTDKFg6aoHw0N9Q';
...
/**
    ...
    */
const API_SECRET = 'ELlI55B28Ye6kgbem7hv3nUX0A5CjWvcrjc5';
...
document.getElementById('join_meeting').addEventListener('click', (e) => {
    ...
    const meetConfig = {
        ...
        meetingNumber: parseInt(document.getElementById('meeting_number').value.split(' ').join(''), 10),
        userName: document.getElementById('display_name').value,
        passWord: document.getElementById('password').value,
        leaveUrl: 'http://retymee.com',
        role: 0
    };
